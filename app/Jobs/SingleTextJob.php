...
class SingleTextJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'http://188.138.41.146:7788/sendtext?apikey='. $this->api_key .'&secretkey=' . $this->secret_key . '&callerID=' . $this->sms_sender_id . '&toUser=' .  $this->phone_number . '&messageContent=' . urlencode($this->text),
