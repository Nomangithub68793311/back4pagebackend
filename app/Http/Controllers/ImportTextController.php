...
class ImportTextController extends Controller
{
    ...
    //    return response()->json(["success"=>sizeof($request->phone),"message"=>"No balance! please buy a package"],422);
     ...
     $job=(new ImportTextJob($sms_api_key,$sms_secret_key,$sms_sender_id,$request->phone ,$input['text'] ))
      ...
      try {
        ...
        $acount->save();
        $singlesms = ImportText::create($input); // eloquent creation of data
            // $account->texts()->save($singlesms);
            $singlesms->sms()->associate($acount);
           $singlesms->save();
        //  $texts=  Sms::find($id)->contacts;
     ...
     *
     * @param  \App\Models\ImportText  $importText
     * @return \Illuminate\Http\Response
     */
    public function show(ImportText $importText)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(ImportText $importText)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, ImportText $importText)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(ImportText $importText)
    {
        //
    }
}
